...
void AProjectLiminalCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AProjectLiminalCharacter::GetHasRifle()
{
	return bHasRifle;
}
...
void AProjectLiminalCharacter::SweepForInteractable()
{
	...
	bool bHit = GetWorld()->SweepSingleByChannel(HitResult, StartLocation, EndLocation, FQuat::Identity, ECC_GameTraceChannel2, FCollisionShape::MakeSphere(5.0f), CollisionParams);
